...
int main()
{
    ...
    char estado1[50] = {"RJ"}, estado2[50] = {"SP"};
    char codigoCarta1[20] = {"A01"}, codigoCarta2[20] = {"B02"};
    char nomeCidade1[100] = {"Niteroi"}, nomeCidade2[100] = {"Jundiai"};
    int populacao1 = 481749, populacao2 = 443221;
    float area1 = 133757, area2 = 431204;
    float pib1 = 128.33, pib2 = 135.08;
    int pontosTuristicos1 = 40, pontosTuristicos2 = 35;
    ...
    printf("***SUPER TRUNFO***\n\n");
    printf("As cartas já estão cadastradas.\n");
